define(['underscore', 'jquery', 'js/components/feedback_mediator', 'js/components/api_feedback', 'js/widgets/widget_states', 'js/components/alerts', 'js/components/api_response', 'analytics'], function (_, $, FeedbackMediator, ApiFeedback, WidgetStates, Alerts, ApiResponse, analytics) {
  var handlers = {};
  ...
  handlers[ApiFeedback.CODES.SEARCH_CYCLE_STARTED] = function (feedback) {
    ...
    var ids = _.keys(feedback.cycle.waiting); // remove alerts from previous searches
