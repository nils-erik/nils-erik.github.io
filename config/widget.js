define(['backbone', 'js/components/api_query', 'js/components/api_request', 'js/widgets/base/base_widget', 'js/components/api_query_updater', 'analytics', 'react', 'react-dom', 'react-redux', './facet-container.jsx', './actions', './reducers', './create_store', 'utils'], function (Backbone, ApiQuery, ApiRequest, BaseWidget, ApiQueryUpdater, analytics, React, ReactDOM, ReactRedux, ContainerComponent, createActionObject, Reducers, createStore, utils) {
