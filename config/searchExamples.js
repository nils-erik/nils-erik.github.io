define([], function () {
  var searchExamples = [{
    ...
    tooltip: 'finds articles citing the most relevant papers on the topic being researched'
  }, {
    label: 'refereed',
    ...
    tooltip: 'default logic is AND, e.g. abs:(planet star) would be interpreted as abs:(planet AND star)'
  }];
