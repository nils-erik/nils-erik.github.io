define(['underscore', 'marionette', 'd3', 'js/widgets/base/base_widget', './extractor_functions', 'js/components/api_response', 'js/components/json_response', 'js/components/api_request', 'js/components/api_query', 'js/mixins/dependon', 'hbs!js/widgets/metrics/templates/metrics_container', 'hbs!js/widgets/metrics/templates/graph_template', 'hbs!js/widgets/metrics/templates/paper_table', 'hbs!js/widgets/metrics/templates/citations_table', 'hbs!js/widgets/metrics/templates/indices_table', 'hbs!js/widgets/metrics/templates/reads_table', 'bootstrap', 'js/components/api_feedback', 'js/components/api_targets', './d3-tip'], function (_, Marionette, d3, BaseWidget, DataExtractor, ApiResponse, JsonResponse, ApiRequest, ApiQuery, Dependon, MetricsContainer, GraphTemplate, PaperTableTemplate, CitationsTableTemplate, IndicesTableTemplate, ReadsTableTemplate, bs, ApiFeedback, ApiTargets, d3Tip) {
  ...
  var GraphView = Marionette.ItemView.extend({
    ...
    drawHistogram: function drawHistogram() {
      ...
      setTimeout(function () {
        svg.append('g').attr('class', 'legend').attr('transform', 'translate(70, 20)').attr('data-style-padding', 7).style('font-size', '12px').call(d3.legend);
    ...
    drawLineGraph: function drawLineGraph() {
      ...
      setTimeout(function () {
        svg.append('g').attr('class', 'legend').attr('transform', 'translate(70, 36)').attr('data-style-padding', 7).style('font-size', '12px').call(d3.legend);
      }, 500);
    },
  ...
  var MetricsWidget = BaseWidget.extend({
    ...
    insertViews: function insertViews() {
