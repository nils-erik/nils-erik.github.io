define(['marionette', 'd3', 'js/components/api_targets', 'js/mixins/user_change_rows', 'js/components/api_request', 'js/components/api_query', 'js/widgets/base/base_widget', 'js/components/api_query_updater', 'hbs!js/widgets/network_vis/templates/author-details-template', 'hbs!js/widgets/network_vis/templates/container-template', 'hbs!js/widgets/network_vis/templates/filter-container-template', 'hbs!js/widgets/network_vis/templates/graph-container-template', 'hbs!js/widgets/network_vis/templates/group-details-template', 'hbs!js/widgets/network_vis/templates/not-enough-data-template', 'hbs!js/widgets/network_vis/templates/network_metadata', 'hbs!js/widgets/network_vis/templates/loading-template', 'hbs!js/widgets/network_vis/templates/default-details-template', 'bootstrap'], function (Marionette, d3, ApiTargets, UserChangeMixin, ApiRequest, ApiQuery, BaseWidget, ApiQueryUpdater, authorDetailsTemplate, containerTemplate, filterContainerTemplate, graphContainerTemplate, groupDetailsTemplate, notEnoughDataTemplate, metadataTemplate, loadingTemplate, DefaultDetailsTemplate) {
  ...
  var ContainerView = Marionette.ItemView.extend({
    ...
    showDetailView: function showDetailView(selected) {
